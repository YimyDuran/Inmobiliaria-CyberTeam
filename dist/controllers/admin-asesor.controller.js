...
exports.AdminAsesorController = void 0;
const tslib_1 = require("tslib");
const repository_1 = require("@loopback/repository");
const rest_1 = require("@loopback/rest");
const models_1 = require("../models");
const repositories_1 = require("../repositories");
let AdminAsesorController = class AdminAsesorController {
...
(0, tslib_1.__decorate)([
    (0, rest_1.get)('/admins/{id}/asesors', {
        responses: {
            '200': {
...
], AdminAsesorController.prototype, "find", null);
(0, tslib_1.__decorate)([
    (0, rest_1.post)('/admins/{id}/asesors', {
        responses: {
            '200': {
    ...
    (0, tslib_1.__metadata)("design:returntype", Promise)
], AdminAsesorController.prototype, "create", null);
(0, tslib_1.__decorate)([
    (0, rest_1.patch)('/admins/{id}/asesors', {
        responses: {
            '200': {
    ...
    (0, tslib_1.__metadata)("design:returntype", Promise)
], AdminAsesorController.prototype, "patch", null);
(0, tslib_1.__decorate)([
    (0, rest_1.del)('/admins/{id}/asesors', {
        responses: {
            '200': {
    ...
    (0, tslib_1.__metadata)("design:paramtypes", [String, Object]),
    (0, tslib_1.__metadata)("design:returntype", Promise)
], AdminAsesorController.prototype, "delete", null);
AdminAsesorController = (0, tslib_1.__decorate)([
...
], AdminAsesorController);
exports.AdminAsesorController = AdminAsesorController;
//# sourceMappingURL=admin-asesor.controller.js.map